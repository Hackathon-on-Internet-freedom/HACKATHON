...
## Стрим с объявлением победителей Хакатона:
[![Стрим с объявлением победителей Хакатона](http://img.youtube.com/vi/RhUN-gU_7os/0.jpg)](http://www.youtube.com/watch?v=RhUN-gU_7os)

### Хакатон Интернет Свободы закончился: объявляем победителей
С 5 по 7 июня мы провели онлайн-хакатон. Мы пригласили на него программистов, разработчиков, правозащитников, журналистов — и предложили поработать над проектами, которые могли бы принести пользу российскому интернету и гражданскому обществу. После окончания хакатона жюри оценило все проекты, дошедшие до финала, и выбрало победителей. Рассказываем, как это было и кто занял первые места.

В финале хакатона участвовали 16 команд [(описания их проектов можно посмотреть здесь)](projects.md). Мы пригласили в жюри представителей разных направлений — от технических директоров до визуализаторов (стримы, которые мы проводили с членами нашего жюри, можно посмотреть здесь) и попросили их оценить проекты по четырем критериям:
...
**Проект «Карта репрессий»**

Карта репрессий отображает случаи преследования пользователей в интернете по всей России. На карте можно увидеть, в каком регионе больше всего нарушений и какие платформы и соцсети чаще фигурируют в новостях о возбуждении дел за репосты. Такая карта есть у ОЗИ — и команда, пришедшая на хакатон, решила ее модернизировать: переделать на плиточную, добавить аналитику и прикрутить возможность импортировать данные по регионам напрямую из таблички, где они собираются, чтобы в итоге создать универсальный инструмент, которым смогли бы пользоваться и другие ресурсы.

> «Мне нравится то, что кроме решения своих задач авторы реализовали возможность того, чтобы к нему дальше могли „цепляться“ другие проекты, что облегчает порог вхождения для продолжения данной работы другими командами».

*Алексей Семеняка, технический советник RIPE NCC*

### 2 место

**Проект InStorm**

Доступная обычным людям меш-сеть для передачи данных в изменяющихся условиях (митинг, природный катаклизм, полный шатдаун интернета, мониторинг чего-либо). Позволяет пересылать важные сообщения и быстро и оперативно обмениваться информацией без необходимости создания отдельной сети.

>«Мой фаворит — элегантное решение, правильно презентованное и достаточно проработанное в рамках хакатона, имеющее гигантское количество вариантов дальнейшего развития».

*Ильдар Якубов, художник, куратор и преподаватель в области новых медиа*

### 3 место

**Проект Kill Switch**

Killswitch — это приложение и небольшой аппаратный токен, предназначенные для инициации локального вайпа android-устройства в случае, когда пользователь потерял контроль — например, если телефон отобрали сотрудники правоохранительных органов. «Взведенное» (armed) приложение постоянно мониторит связность с токеном. В случае потери связности, или нажатия пользователем на «красную кнопку» токена происходит вайп. Даже после перезагрузки.

>«Проект решает очень важную проблему и находит достаточно элегантное решение. Я считаю, у проекта много перспектив, и советую посотрудничать с хакерспейсами, которым могло бы быть интересно сделать прототипы коробочек для устройства и протестить его с активистами реальных НКО для получения фидбека по юзабилити мобильного приложения».

*Ксения Ермошина, научная сотрудница Center for Internet and Society (Франция) и Citizen Lab (Канада), UX-дизайнер Delta.Chat*

Поздравляем победителей (мы свяжемся с вами отдельно, чтобы передать призы) и хотим сказать огромное спасибо всем, кто участвовал в хакатоне! Вы и есть сопротивление :)

Хакатон на этом заканчивается, но работа продолжается. Мы готовы поддержать все проекты советами, идеями или связями в международном и российском сообществе.

# Таймлайн

- [x] Сбор заявок - ~~до 27 мая~~ 30 МАЯ
- [x] Формирование команд - с 31 мая по 4 июня
- [x] Он-лайн хакатон - 4-7 июня
- [x] Подведение итогов - с 8 по 14 июня
...
2. [Финал Хакатона](#final)

3. [Стримы Хакатона](#video)

4. [Участники](#participates)
  * [Разработчики и программисты](#develop)
  * [Журналисты и блогеры](#blogers)
  * [Аналитики](#analyzer)
  * [Художники и дизайнеры](#arts)
  
5. [Темы хакатона](#themes)
...
6. [Процесс](#proccess)
 ...
 7. [Ресурсы и обратная связь](#source)
---
...
# <a name="final"></a>Стрим финала

## Финал Хакатона:
[![Видео финала хакатона](http://img.youtube.com/vi/cZev4MToQT4/0.jpg)](http://www.youtube.com/watch?v=cZev4MToQT4)
...
## Нужные вещи - 20+ идей для проекта, Владислав Романцов, ИТ ФБК:
[![Стрим с Владиславом Романцовым, ИТ ФБК](http://img.youtube.com/vi/2Wd5mVjY4Rc/0.jpg)](http://www.youtube.com/watch?v=2Wd5mVjY4Rc)

## Стрим с финальных презентаций проектов:
[![Стрим с финальных презентаций проектов](http://img.youtube.com/vi/cZev4MToQT4/0.jpg)](http://www.youtube.com/watch?v=cZev4MToQT4)
